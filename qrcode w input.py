...
headingFrame = Frame(wn,bg="#2F4F4F",bd=5)
headingFrame.place(relx=0.15,rely=0.05,relwidth=0.7,relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code", bg='#2F4F4F', font=('Times',20,'bold'))
...
label1 = Label(Frame1,text="Enter the text/URL: ",bg="black",fg='#2F4F4F',font=('Courier',13,'bold'))
...
label2 = Label(Frame2,text="Enter the location to save the QR Code: ",bg="black",fg='#2F4F4F',font=('Courier',13,'bold'))
...
label3 = Label(Frame3,text="Enter the name of the QR Code: ",bg="black",fg='#2F4F4F',font=('Courier',13,'bold'))
...
label4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="black",fg='#2F4F4F',font=('Courier',13,'bold'))
